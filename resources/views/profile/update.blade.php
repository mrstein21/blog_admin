            ...
            <div class="kt-portlet__body">
                <div class="tab-content">
						...
						<div class="tab-pane active" id="kt_widget11_tab1_content">
                          <form class="kt-form" method="POST" action="{{ route('profile.update',Auth::user()->id) }}">
                            {{ csrf_field() }}
                            {{ method_field("PATCH")}}
							<div class="kt-portlet__body">
                              <div class="kt-section kt-section--first">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                           <img id="holder" src="@isset(Auth::user()->avatar) {{ asset(Auth::user()->avatar) }}  @endisset" style="margin-top:15px;max-height:254px;max-width: 152px;">
                                           <br>
                                           <br>
                                           ...
                                           <input type="hidden" value="{{ Auth::user()->avatar }}"    name="avatar" id="avatar"/>
                                          </span>
                                          <br>
                                        </div>
                                    </div>
